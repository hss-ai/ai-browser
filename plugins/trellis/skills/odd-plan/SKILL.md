...
3. Route to the next incomplete planning stage using `currentStage` from `.odd/trellis-state.json` when available:
   - `context-governance` → `plugins/trellis/skills/trellis/docs/planning/school-discovery.md`
   - `personas` → `plugins/trellis/skills/trellis/docs/planning/persona-architect.md`
   - `outcomes` → `plugins/trellis/skills/trellis/docs/planning/outcome-writer.md`
   - `contracts` → `plugins/trellis/skills/trellis/docs/planning/systems-mapper.md`
   - `architecture` → `plugins/trellis/skills/trellis/docs/planning/architecture-planner.md`
   - `ui-ux` → `plugins/trellis/skills/trellis/docs/planning/ui-ux-planner.md`
   - `compliance-safeguarding` → `plugins/trellis/skills/trellis/docs/planning/compliance-planner.md`
   - `delivery-decisions` → `plugins/trellis/skills/trellis/docs/planning/delivery-planner.md`
   - `operations-handover` → `plugins/trellis/skills/trellis/docs/planning/operations-planner.md`
   - `build-plan` → `plugins/trellis/skills/trellis/docs/planning/build-planner.md`
   - `verify` → `plugins/trellis/skills/trellis/docs/planning/verification-planner.md`
   - `inspection-pack` → `plugins/trellis/skills/trellis/docs/planning/inspection-pack-planner.md`
