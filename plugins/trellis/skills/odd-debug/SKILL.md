...
After choosing the strategy, load `plugins/trellis/skills/trellis/docs/build/debug-protocol.md` for the detailed investigation procedure for that strategy.
