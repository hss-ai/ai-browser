...
3. Route to the next incomplete planning stage using `currentStage` from `.odd/trellis-state.json` when available:
   - `context-governance` → `.claude/skills/trellis/docs/planning/school-discovery.md`
   - `personas` → `.claude/skills/trellis/docs/planning/persona-architect.md`
   - `outcomes` → `.claude/skills/trellis/docs/planning/outcome-writer.md`
   - `contracts` → `.claude/skills/trellis/docs/planning/systems-mapper.md`
   - `architecture` → `.claude/skills/trellis/docs/planning/architecture-planner.md`
   - `ui-ux` → `.claude/skills/trellis/docs/planning/ui-ux-planner.md`
   - `compliance-safeguarding` → `.claude/skills/trellis/docs/planning/compliance-planner.md`
   - `delivery-decisions` → `.claude/skills/trellis/docs/planning/delivery-planner.md`
   - `operations-handover` → `.claude/skills/trellis/docs/planning/operations-planner.md`
   - `build-plan` → `.claude/skills/trellis/docs/planning/build-planner.md`
   - `verify` → `.claude/skills/trellis/docs/planning/verification-planner.md`
   - `inspection-pack` → `.claude/skills/trellis/docs/planning/inspection-pack-planner.md`
